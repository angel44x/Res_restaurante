				...
				<?php
					...
					if($infoproducto["detalles"] != null){
						...
						if($infoproducto["tipo"] == "fisico"){
							...
							if($detalles["Hora"]!=null){

								echo '<div class="col-md-3 col-xs-12">

									<select class="form-control seleccionarDetalle" id="seleccionarHora">
										
										<option value="">Hora</option>';

										for($i = 0; $i <= count($detalles["Hora"]); $i++){

											echo '<option value="'.$detalles["Hora"][$i].'">'.$detalles["Hora"][$i].'</option>';
							...
							if($detalles["Servicio"]!=null){
								...
								echo '<div class="col-md-3 col-xs-12">
									...
									<select class="form-control seleccionarDetalle" id="seleccionarServicio">
										
										<option value="">Servicio</option>';

										for($i = 0; $i <= count($detalles["Servicio"]); $i++){

											echo '<option value="'.$detalles["Servicio"][$i].'">'.$detalles["Servicio"][$i].'</option>';
